namespace iTextSharp.text.pdf.collection
{
    public class PdfTargetDictionary : PdfDictionary
    {
        ...
        /// </summary>
        /// <param name="child">if false, this refers to the parent document; if true, this refers to a child document, and you'll have to specify where to find the child using the other methods of this class</param>
