namespace iTextSharp.text.pdf
{
    ...
    public abstract class ExtendedColor : BaseColor
    {
        ...
        protected ExtendedColor(int type) : base(0, 0, 0)
        {
            this.type = type;
        }

        protected ExtendedColor(int type, float red, float green, float blue) : base(Normalize(red), Normalize(green), Normalize(blue))
        {
            this.type = type;
        }
