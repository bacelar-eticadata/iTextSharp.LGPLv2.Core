...
namespace iTextSharp.text.pdf
{
    ...
    public class PdfCopyFields : IPdfViewerPreferences, IPdfEncryptionSettings
    {
        ...
        {
            _fc = new PdfCopyFieldsImp(os, pdfVersion);
        }
        ...
        {
            _fc.SetEncryption(userPassword, ownerPassword, permissions, strength128Bits ? PdfWriter.STANDARD_ENCRYPTION_128 : PdfWriter.STANDARD_ENCRYPTION_40);
        }
