...
namespace iTextSharp.text.pdf
{
    ...
    public class PdfContentByte
    {
        ...
        private static readonly Hashtable _abrev = new Hashtable();
        ...
        public static ArrayList BezierArc(float x1, float y1, float x2, float y2, float startAng, float extent)
        {
            ...
            for (var i = 0; i < nfrag; ++i)
            {
                ...
                if (fragAngle > 0f)
                {
                    pointList.Add(new[]{xCen + rx * cos0,
                                                 yCen - ry * sin0,
        ...
        {
            if (llx > urx) { var x = llx; llx = urx; urx = x; }
            if (lly > ury) { var y = lly; lly = ury; ury = y; }
