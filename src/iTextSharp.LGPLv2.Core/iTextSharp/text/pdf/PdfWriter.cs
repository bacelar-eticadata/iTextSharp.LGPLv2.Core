...
namespace iTextSharp.text.pdf
{
        ...
        IPdfAnnotations
  {
    ...
    /// </summary>
    public static readonly PdfName PdfVersion12 = new PdfName("1.2");

    /// <summary>
    /// possible PDF version (catalog)
    /// </summary>
    public static readonly PdfName PdfVersion13 = new PdfName("1.3");

    /// <summary>
    /// possible PDF version (catalog)
    /// </summary>
    public static readonly PdfName PdfVersion14 = new PdfName("1.4");

    /// <summary>
    /// possible PDF version (catalog)
    /// </summary>
    public static readonly PdfName PdfVersion15 = new PdfName("1.5");

    /// <summary>
    /// possible PDF version (catalog)
    /// </summary>
    public static readonly PdfName PdfVersion16 = new PdfName("1.6");

    /// <summary>
    /// possible PDF version (catalog)
    /// </summary>
    public static readonly PdfName PdfVersion17 = new PdfName("1.7");
    ...
    /// </summary>
    private readonly Hashtable _images = new Hashtable();
    ...
    /// </summary>
    private readonly PdfXConformanceImp _pdfxConformance = new PdfXConformanceImp();
    ...
    public PdfName AddDirectImageSimple(Image image, PdfIndirectReference fixedRef)
    {
      ...
      {
        name = (PdfName)_images[image.MySerialId];
      }
      ...
      else
      {
        ...
        else
        {
          ...
          if (maskImage != null)
          {
            var mname = (PdfName)_images[maskImage.MySerialId];
    ...
    public virtual void AddFileAttachment(string description, byte[] fileStore, string file, string fileDisplay) => AddFileAttachment(description, PdfFileSpecification.FileEmbedded(this, file, fileDisplay, fileStore));
    ...
    public virtual void AddFileAttachment(string description, PdfFileSpecification fs) => Pdf.AddFileAttachment(description, fs);

    /// <summary>
    /// Adds a file attachment at the document level.
    /// </summary>
    /// <param name="fs">the file specification</param>
    public void AddFileAttachment(PdfFileSpecification fs) => Pdf.AddFileAttachment(null, fs);
    ...
    public virtual void AddJavaScript(PdfAction js) => Pdf.AddJavaScript(js);
    ...
    public virtual void AddJavaScript(string code, bool unicode) => AddJavaScript(PdfAction.JavaScript(code, this, unicode));
    ...
    /// </summary>
    /// <param name="code">the JavaScript code</param>
    public virtual void AddJavaScript(string code) => AddJavaScript(code, false);
    ...
    /// <param name="js">The JavaScript action</param>
    public void AddJavaScript(string name, PdfAction js) => Pdf.AddJavaScript(name, js);
    ...
    /// <param name="code">the JavaScript code</param>
    /// <param name="unicode">select JavaScript unicode. Note that the internal</param>
    public void AddJavaScript(string name, string code, bool unicode) => AddJavaScript(name, PdfAction.JavaScript(code, this, unicode));
    ...
    /// <param name="name">The name of the JS Action in the name tree</param>
    /// <param name="code">the JavaScript code</param>
    public void AddJavaScript(string name, string code) => AddJavaScript(name, code, false);
    ...
    {
      var inst = (PdfReaderInstance)ImportedPages[reader];
      if (inst == null)
      {
    ...
    public void LockLayer(PdfLayer layer) => OcgLocked.Add(layer.Ref);
    ...
    public override void Open()
    {
      ...
      if (_pdfxConformance.IsPdfX32002())
      {
        ...
        sec.Put(PdfName.Matrix, new PdfArray(new[] { 0.4124f, 0.2126f, 0.0193f, 0.3576f, 0.7152f, 0.1192f, 0.1805f, 0.0722f, 0.9505f }));
    ...
    public void ReleaseTemplate(PdfTemplate tp)
    {
      ...
      var objs = (object[])FormXObjects[refi];
    ...
    public void SetEncryption(byte[] userPassword, byte[] ownerPassword, int permissions, bool strength128Bits) => SetEncryption(userPassword, ownerPassword, permissions, strength128Bits ? STANDARD_ENCRYPTION_128 : STANDARD_ENCRYPTION_40);
    ...
    /// <param name="ownerPassword">the owner password. Can be null or empty</param>
    /// <param name="permissions">the user permissions</param>
    public void SetEncryption(bool strength, string userPassword, string ownerPassword, int permissions) => SetEncryption(GetIsoBytes(userPassword), GetIsoBytes(ownerPassword), permissions, strength);
    ...
    /// <param name="ownerPassword">the owner password. Can be null or empty</param>
    /// <param name="permissions">the user permissions</param>
    public void SetEncryption(int encryptionType, string userPassword, string ownerPassword, int permissions) => SetEncryption(GetIsoBytes(userPassword), GetIsoBytes(ownerPassword), permissions, encryptionType);
    ...
    /// </summary>
    public void SetLinearPageMode() => Root.SetLinearMode(null);
    ...
    internal PdfName AddDirectTemplateSimple(PdfTemplate template, PdfName forcedName)
    {
      ...
      var obj = (object[])FormXObjects[refa];
      PdfName name = null;
      if (obj == null)
      {
        if (forcedName == null)
    ...
    /// [F6] spot colors
    /// </summary>
    internal PdfName GetColorspaceName() => new PdfName("CS" + (ColorNumber++));
    ...
    /// <returns>a  PdfIndirectReference </returns>
    internal virtual PdfIndirectReference GetImageReference(PdfName name) => (PdfIndirectReference)ImageDictionary.Get(name);
    ...
    protected void AddSharedObjectsToBody()
    {
      ...
      {
        var gstate = (PdfDictionary)entry.Key;
        var obj = (PdfObject[])entry.Value;
    ...
    protected void FillOcProperties(bool erase)
    {
      ...
      var docOrder = new ArrayList(DocumentOcGorder);
      for (var it = new ListIterator(docOrder); it.HasNext();)
      {
    ...
    private void addAsEvent(PdfName eventa, PdfName category)
    {
      ...
      foreach (PdfLayer layer in DocumentOcg.Keys)
      {
        var usage = (PdfDictionary)layer.Get(PdfName.Usage);
    ...
    public class PdfBody
    {
      ...
      /// </summary>
      /// <returns>a  PdfIndirectObject </returns>
      internal PdfIndirectObject Add(PdfObject objecta, bool inObjStm) => Add(objecta, IndirectReferenceNumber, inObjStm);
      ...
      /// </summary>
      /// <returns>a  PdfIndirectObject </returns>
      internal PdfIndirectObject Add(PdfObject objecta, PdfIndirectReference refa, bool inObjStm) => Add(objecta, refa.Number, inObjStm);
