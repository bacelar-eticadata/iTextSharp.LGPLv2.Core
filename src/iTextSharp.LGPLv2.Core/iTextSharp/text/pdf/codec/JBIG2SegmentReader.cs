...
namespace iTextSharp.text.pdf.codec
{
    ...
    public class Jbig2SegmentReader
    {
        ...
        private readonly OrderedTree _segments = new OrderedTree();
        ...
        {
            return (Jbig2Page)_pages[page];
        }

        public int GetPageHeight(int i)
        {
            return ((Jbig2Page)_pages[i]).PageBitmapHeight;
        }

        public int GetPageWidth(int i)
        {
            return ((Jbig2Page)_pages[i]).PageBitmapWidth;
        }
        ...
        public class Jbig2Segment : IComparable
        {
            ...
            {
                return CompareTo((Jbig2Segment)o);
            }
