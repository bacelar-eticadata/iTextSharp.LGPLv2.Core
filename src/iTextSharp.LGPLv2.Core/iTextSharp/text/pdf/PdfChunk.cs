...
namespace iTextSharp.text.pdf
{
    ...
    public class PdfChunk
    {
        ...
        internal BaseColor Color => (BaseColor)NoStroke[Chunk.COLOR];
        ...
        internal float Width => font.Width(value);
        ...
        public PdfChunk Split(float width)
        {
            ...
            if (hyphenationEvent != null && lastSpace >= 0 && lastSpace < currentPosition)
            {
                ...
                {
                    var pre = hyphenationEvent.GetHyphenatedWordPre(value.Substring(lastSpace, wordIdx - lastSpace), font.Font, font.Size, width - lastSpaceWidth);
