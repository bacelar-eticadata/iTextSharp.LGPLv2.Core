...
namespace iTextSharp.text
{
    ...
    public class Document : IDocListener
    {
        ...
        {
            return PageSize.GetBottom(BottomMargin + margin);
        }
        ...
        {
            return PageSize.GetLeft(LeftMargin + margin);
        }
        ...
        {
            return PageSize.GetRight(RightMargin + margin);
        }
        ...
        {
            return PageSize.GetTop(TopMargin + margin);
        }
