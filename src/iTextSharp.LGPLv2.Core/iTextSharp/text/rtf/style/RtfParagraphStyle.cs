...
namespace iTextSharp.text.rtf.style
{
    ...
    public class RtfParagraphStyle : RtfFont
    {
        ...
        /// </summary>
        public static readonly RtfParagraphStyle StyleHeading1 = new RtfParagraphStyle("heading 1", "Normal");

        /// <summary>
        /// The style for level 2 headings.
        /// </summary>
        public static readonly RtfParagraphStyle StyleHeading2 = new RtfParagraphStyle("heading 2", "Normal");

        /// <summary>
        /// The style for level 3 headings.
        /// </summary>
        public static readonly RtfParagraphStyle StyleHeading3 = new RtfParagraphStyle("heading 3", "Normal");
        ...
        public RtfParagraphStyle(string styleName, string fontName, int fontSize, int fontStyle, BaseColor fontColor) : base(null, new RtfFont(fontName, fontSize, fontStyle, fontColor))
        {
