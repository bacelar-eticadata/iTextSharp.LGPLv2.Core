...
namespace iTextSharp.text.rtf.style
{
    ...
    public class RtfFont : Font, IRtfExtendedElement
    {
        ...
        public RtfFont(string fontName) : base(UNDEFINED, UNDEFINED, UNDEFINED, null)
        {
            _fontName = fontName;
        }
        ...
        public RtfFont(string fontName, float size) : base(UNDEFINED, size, UNDEFINED, null)
        {
            _fontName = fontName;
        }
        ...
        public RtfFont(string fontName, float size, int style) : base(UNDEFINED, size, style, null)
        {
            _fontName = fontName;
        }
        ...
        public RtfFont(string fontName, float size, int style, BaseColor color, int charset) : this(fontName, size, style, color)
        {
            _charset = charset;
        }
        ...
        {
            return (_fontName + _fontSize + "-" + _fontStyle).GetHashCode();
        }
