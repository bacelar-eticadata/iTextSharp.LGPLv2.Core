...
namespace iTextSharp.text.rtf.table
{
    ...
    public class RtfBorderGroup : RtfElement
    {
        ...
        /// </summary>
        private readonly Hashtable _borders;
        ...
        /// </summary>
        /// <param name="bordersToAdd">The borders to add (Rectangle.LEFT, Rectangle.RIGHT, Rectangle.TOP, Rectangle.BOTTOM, Rectangle.BOX)</param>
        ...
        /// <param name="doc">The RtfDocument this RtfBorderGroup belongs to</param>
        /// <param name="borderType">The type of borders this RtfBorderGroup contains</param>
        /// <param name="bordersToUse">The borders to add (Rectangle.LEFT, Rectangle.RIGHT, Rectangle.TOP, Rectangle.BOTTOM, Rectangle.BOX)</param>
        /// <param name="borderWidth">The border width to use</param>
        /// <param name="borderColor">The border color to use</param>
        protected internal RtfBorderGroup(RtfDocument doc, int borderType, int bordersToUse, float borderWidth, BaseColor borderColor) : base(doc)
        {
            _borderType = borderType;
            _borders = new Hashtable();
        ...
        {
            foreach (RtfBorder rb in _borders.Values)
            {
