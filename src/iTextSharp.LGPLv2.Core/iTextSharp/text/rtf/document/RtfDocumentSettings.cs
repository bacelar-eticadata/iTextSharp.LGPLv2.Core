...
namespace iTextSharp.text.rtf.document
{
    ...
    public class RtfDocumentSettings
    {
        ...
        {
            return _alwaysGenerateSoftLinebreaks;
        }
        ...
        {
            return _outputTableRowDefinitionAfter;
        }
        ...
        {
            return _writeImageScalingInformation;
        }
