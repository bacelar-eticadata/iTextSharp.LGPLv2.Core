...
namespace iTextSharp.text.rtf.parser.properties
{
    ...
    public class RtfProperty
    {
        ...
        public void AfterChange(string propertyName)
        {
            ...
            foreach (IRtfPropertyListener listener in _listeners)
            {
        ...
        {
            return _modifiedCharacter || _modifiedParagraph || _modifiedSection || _modifiedDocument;
        }
