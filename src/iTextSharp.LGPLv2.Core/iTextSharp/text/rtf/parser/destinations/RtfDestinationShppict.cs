...
namespace iTextSharp.text.rtf.parser.destinations
{
    ...
    public class RtfDestinationShppict : RtfDestination
    {
        ...
        private StringBuilder _hexChars = new StringBuilder(0);
        /// <summary>
        /// picscalexN
        /// </summary>
        ...
        public override bool HandleCharacter(int ch)
        {
            ...
            switch (_dataFormat)
            {
                ...
                case FORMAT_BINARY:
                    ...
                    _binaryLength--;
                    if (_binaryLength == 0) { _dataFormat = FORMAT_HEXADECIMAL; }
                    break;
            }
        ...
        public override bool HandleControlWord(RtfCtrlWordData ctrlWordData)
        {
            ...
            if (RtfParser.IsImport())
            {
                ...
                if (ctrlWordData.CtrlWord.Equals("blipuid")) { skipCtrlWord = true; RtfParser.SetTokeniserStateSkipGroup(); result = true; }
                if (ctrlWordData.CtrlWord.Equals("picprop")) { skipCtrlWord = true; RtfParser.SetTokeniserStateSkipGroup(); result = true; }
                ...
                if (ctrlWordData.CtrlWord.Equals("picw")) { _width = ctrlWordData.LongValue(); result = true; }
                if (ctrlWordData.CtrlWord.Equals("pich")) { _height = ctrlWordData.LongValue(); result = true; }
                if (ctrlWordData.CtrlWord.Equals("picwgoal")) { _desiredWidth = ctrlWordData.LongValue(); result = true; }
                if (ctrlWordData.CtrlWord.Equals("pichgoal")) { _desiredHeight = ctrlWordData.LongValue(); result = true; }
                if (ctrlWordData.CtrlWord.Equals("picscalex")) { _scaleX = ctrlWordData.IntValue(); result = true; }
                if (ctrlWordData.CtrlWord.Equals("picscaley")) { _scaleY = ctrlWordData.IntValue(); result = true; }
                if (ctrlWordData.CtrlWord.Equals("picscaled")) { result = true; }
                if (ctrlWordData.CtrlWord.Equals("picprop")) { skipCtrlWord = true; RtfParser.SetTokeniserStateSkipGroup(); result = true; }
                if (ctrlWordData.CtrlWord.Equals("defshp")) { result = true; }
                if (ctrlWordData.CtrlWord.Equals("piccropt")) { _cropTop = ctrlWordData.IntValue(); result = true; }
                if (ctrlWordData.CtrlWord.Equals("piccropb")) { _cropBottom = ctrlWordData.IntValue(); result = true; }
                if (ctrlWordData.CtrlWord.Equals("piccropl")) { _cropLeft = ctrlWordData.IntValue(); result = true; }
                if (ctrlWordData.CtrlWord.Equals("piccropr")) { _cropRight = ctrlWordData.IntValue(); result = true; }
            ...
            {
                if (ctrlWordData.CtrlWord.Equals("shppict")) { result = true; }
                if (ctrlWordData.CtrlWord.Equals("nonshppict")) { skipCtrlWord = true; RtfParser.SetTokeniserStateSkipGroup(); result = true; }
                if (ctrlWordData.CtrlWord.Equals("blipuid")) { result = true; RtfParser.SetTokeniserStateSkipGroup(); result = true; }
                if (ctrlWordData.CtrlWord.Equals("pict")) { result = true; }
                ...
                if (ctrlWordData.CtrlWord.Equals("wmetafile")) { skipCtrlWord = true; RtfParser.SetTokeniserStateSkipGroup(); result = true; }
