...
namespace iTextSharp.text.rtf.headerfooter
{
    ...
    public class RtfHeaderFooterGroup : HeaderFooter, IRtfBasicElement
    {
        ...
        public RtfHeaderFooterGroup(RtfDocument doc, RtfHeaderFooterGroup headerFooter, int type) : base(new Phrase(""), false)
        {
            ...
            {
                _headerFirst = new RtfHeaderFooter(_document, headerFooter.GetHeaderFirst(), RtfHeaderFooter.DISPLAY_FIRST_PAGE);
            }
            if (headerFooter.GetHeaderLeft() != null)
            {
                _headerLeft = new RtfHeaderFooter(_document, headerFooter.GetHeaderLeft(), RtfHeaderFooter.DISPLAY_LEFT_PAGES);
            }
            if (headerFooter.GetHeaderRight() != null)
            {
                _headerRight = new RtfHeaderFooter(_document, headerFooter.GetHeaderRight(), RtfHeaderFooter.DISPLAY_RIGHT_PAGES);
            }
            SetType(_type);
        }
        ...
        {
            return (_headerLeft != null || _headerRight != null);
        }
